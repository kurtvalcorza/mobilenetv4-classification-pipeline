...
- Measured, CPU (WSL venv, Intel Core Ultra 9 275HX, `HF_HUB_OFFLINE=1`, `device="cpu"`): load 1.90 s, predict 0.19 s, total 2.08 s, top-1 on a synthetic 256×256 gradient image `nipple` (index 680) at score 0.0248.

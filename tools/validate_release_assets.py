...
CODE_MARKERS = (
    'from mobilenetv4_classification_pipeline import MAX_BATCH, MAX_IMAGE_SIDE, NUM_CLASSES',
    'from mobilenetv4_classification_pipeline import MODEL_ID, MODEL_KEY, MODEL_REVISION, '
    'MobileNetV4ClassificationPipeline, stage_missing_files, top_k_accuracy, verify_snapshot',
    "WEIGHTS_DIR = ROOT / 'weights' / MODEL_KEY",
    'fetched = stage_missing_files(WEIGHTS_DIR, allow_download=True)',
    'snapshot = verify_snapshot(WEIGHTS_DIR)',
    'pipe = MobileNetV4ClassificationPipeline.from_pretrained(weights_dir=WEIGHTS_DIR)',
